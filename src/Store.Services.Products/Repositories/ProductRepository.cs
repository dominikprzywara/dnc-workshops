...
namespace Store.Services.Products.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<Product> GetAsync(Guid id) => await _repository.GetAsync(id);

        public async Task<IEnumerable<Product>> BrowseAsync() => await _repository.FindAsync(_ => true);
