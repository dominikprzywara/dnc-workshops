...
namespace Store.Api.Controllers
{
    ...
    public class ProductsController : BaseController
    {
        ...
        public ProductsController(IBusPublisher busPublisher, IProductService productService)
        {
        ...
        [HttpGet]
        public async Task<ActionResult<object>> Get() => await _productService.BrowseAsync();
